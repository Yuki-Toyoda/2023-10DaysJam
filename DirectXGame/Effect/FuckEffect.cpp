#include "FuckEffect.h"

void FuckEffect::initialize(
...
void FuckEffect::Draw(const ViewProjection& viewProjection) {
	// 粒子ごとに描画
	for (int i = 0; i < kMaxParticleCount_; i++) {
		if (!isEndParticle_[i]) {
